# -*- coding: utf-8 -*-
#
# ros_datacentre documentation build configuration file, created by
...
htmlhelp_basename = 'ros_datacentredoc'
...
latex_documents = [
  ('index', 'ros_datacentre.tex', u'ros\\_datacentre Documentation',
...
man_pages = [
    ('index', 'ros_datacentre', u'ros_datacentre Documentation',
...
texinfo_documents = [
  ('index', 'ros_datacentre', u'ros_datacentre Documentation',
   u'Chris Burbridge, Nick Hawes', 'ros_datacentre', 'One line description of project.',
   'Miscellaneous'),
]
